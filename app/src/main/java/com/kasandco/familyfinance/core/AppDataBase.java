...
@Database(entities = {ListModel.class, ListSyncHistory.class, IconModel.class, ItemModel.class, FinanceCategoryModel.class, FinanceModel.class}, exportSchema = false, version = 1)
